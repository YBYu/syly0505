package com.zzc.web.system.controller.core;
...
import com.zzc.core.common.model.json.ComboBox;
import com.zzc.core.common.model.json.DataGrid;
import com.zzc.core.common.model.json.ValidForm;
import com.zzc.core.constant.Globals;
import com.zzc.core.enums.SysThemesEnum;
import com.zzc.core.util.ListtoMenu;
import com.zzc.core.util.PasswordUtil;
import com.zzc.core.util.ResourceUtil;
import com.zzc.core.util.RoletoJson;
import com.zzc.core.util.SetListSort;
...
import com.zzc.tag.vo.datatable.DataTables;
...
//				}
	...
	public void datagridRole(TSRole tsRole, HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid) {
		...
		cq.add(Restrictions.or(Restrictions.eq("roleName","系统管理员"),Restrictions.eq("roleName", "区级管理员"),Restrictions.eq("roleName", "超级管理员")));
		/*tsRole.setRoleName("系统管理员");*/
		com.zzc.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq, tsRole);
		this.systemService.getDataGridReturn(cq, true);
		TagUtil.datagrid(response, dataGrid);
	}
