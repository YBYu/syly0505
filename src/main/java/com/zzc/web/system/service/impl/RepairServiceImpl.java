...
import com.zzc.core.util.DateUtils;
...
import com.zzc.demo.plugin.entity.test.TSStudent;
import com.zzc.demo.plugin.entity.test.TeacherEntity;
import com.zzc.web.cgform.engine.FreemarkerHelper;
...
import com.zzc.web.system.dao.repair.RepairDao;
import com.zzc.web.system.pojo.base.*;
import com.zzc.web.system.service.RepairService;
...
public class RepairServiceImpl extends CommonServiceImpl implements
	...
	private void repairMatterBom() {
		ZZCMatterBom entity = new ZZCMatterBom();
		entity.setCode("001");
		entity.setName("电脑");
		entity.setUnit("台");
		...
		ZZCMatterBom entity2 = new ZZCMatterBom();
	...
	private void repairOrder() {
		ZZCOrderMainEntity main = new ZZCOrderMainEntity();
		...
		main.setUsertype("1");
		commonDao.save(main);
		ZZCOrderProductEntity product = new ZZCOrderProductEntity();
		...
		ZZCOrderCustomEntity coustom = new ZZCOrderCustomEntity();
	...
	private void repairJeecgNoteEntity() {
		ZZCNoteEntity entity = new ZZCNoteEntity();
		entity.setAge(10);
	...
	private void repairJdbcEntity(){
		ZZCJdbcEntity entity = new ZZCJdbcEntity();
		entity.setAge(12);
	...
	private void repairCkFinder() {
		ZZCDemoCkfinderEntity ckfinder = new ZZCDemoCkfinderEntity();
...
//		commonDao.saveOrUpdate(jform_cgreport_item_field_type);
	...
	private void repairDemo() {
		...
		// 复杂字符串文本读取，采用文件方式存储
		String html = new FreemarkerHelper().parseTemplate("/com/zzc/web/system/txt/valid-code-demo.ftl", null);
...
//		approver.setTSDepart(eiu);
	...
	private void repaireIcon() {
		com.zzc.core.util.LogUtil.info("修复图标中");
	...
	private void repairMenu() {
		...
		TSIcon folder = commonDao.findByProperty(TSIcon.class, "iconName",
				"文件夹").get(0);
		com.zzc.core.util.LogUtil.info(defaultIcon.getIconPath());
