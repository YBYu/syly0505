...
import com.zzc.web.sms.service.TSSmsTemplateSqlServiceI;
import com.zzc.web.sms.util.TuiSongMsgUtil;
...
public class TSSmsTemplateSqlController extends BaseController {
	...
	public void datagrid(TSSmsTemplateSqlEntity tSSmsTemplateSql,HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid) {
		...
		//查询条件组装器
		com.zzc.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq, tSSmsTemplateSql, request.getParameterMap());
		try{
		//自定义追加查询条件
		}catch (Exception e) {
