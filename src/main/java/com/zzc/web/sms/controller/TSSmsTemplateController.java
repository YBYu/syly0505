package com.zzc.web.sms.controller;
...
import com.zzc.web.sms.entity.TSSmsTemplateEntity;
import com.zzc.web.sms.service.TSSmsTemplateServiceI;
...
public class TSSmsTemplateController extends BaseController {
	...
	public void datagrid(TSSmsTemplateEntity tSSmsTemplate,HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid) {
		...
		//查询条件组装器
		com.zzc.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq, tSSmsTemplate, request.getParameterMap());
		try{
		//自定义追加查询条件
		}catch (Exception e) {
