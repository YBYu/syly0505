package com.zzc.web.cgform.controller.cgformftl;
...
import com.zzc.core.util.FormUtil;
...
import com.zzc.web.cgform.common.OfficeHtmlUtil;
import com.zzc.web.cgform.entity.cgformftl.CgformFtlEntity;
import com.zzc.web.cgform.service.cgformftl.CgformFtlServiceI;
...
public class CgformFtlController extends BaseController {
	...
	public ModelAndView ckeditor(HttpServletRequest request, String id) {
		...
		if(request.getParameter("editorType")==null){
			return new ModelAndView("zzc/cgform/cgformftl/ckeditor");
		}else{
			return new ModelAndView("zzc/cgform/cgformftl/"+request.getParameter("editorType"));
		}
	}
	...
	public ModelAndView cgformFtl(HttpServletRequest request) {
		...
		return new ModelAndView("zzc/cgform/cgformftl/cgformFtlList");
	}
	...
	public ModelAndView addorupdate(CgformFtlEntity cgformFtl,
		...
		if("02".equals(cgformFtl.getEditorType())){
			return new ModelAndView("zzc/cgform/cgformftl/cgformFtlUEditor");
		}else if("03".equals(cgformFtl.getEditorType())){
			return new ModelAndView("zzc/cgform/cgformftl/cgformFtl");
		}else{
			return new ModelAndView("zzc/cgform/cgformftl/cgformFtlEditor");
		}
	}
	...
	public ModelAndView cgformFtl2(HttpServletRequest request) {
		String formid = request.getParameter("formid");
		request.setAttribute("formid", formid);
		return new ModelAndView("zzc/cgform/cgformftl/cgformFtlList2");
	}
