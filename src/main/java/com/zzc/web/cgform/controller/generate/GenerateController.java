package com.zzc.web.cgform.controller.generate;
...
import com.zzc.web.cgform.entity.button.CgformButtonSqlEntity;
...
import com.zzc.web.cgform.entity.generate.GenerateEntity;
import com.zzc.web.cgform.entity.generate.GenerateSubListEntity;
import com.zzc.web.cgform.service.button.CgformButtonServiceI;
import com.zzc.web.cgform.service.button.CgformButtonSqlServiceI;
...
public class GenerateController extends BaseController {
	...
	public ModelAndView gogenerate( CgFormHeadEntity cgFormHead,HttpServletRequest request) {
		...
		if(cgFormHead.getJformType()==1 || cgFormHead.getJformType()==3){
			//如果是单表或者附表，则进入单表模型
			returnModelAndView = "zzc/cgform/generate/single";
		}else{
			//如果是主表，则进入一对多模型
	...
	*//**
	...
	public ModelAndView goFileTree(HttpServletRequest request) {
		return new ModelAndView("zzc/cgform/generate/fileTree");
	}
	*//**
	 * 返回子目录json
	 * @param parentNode
