package com.zzc.web.cgform.controller.autolist;
...
import com.zzc.core.util.JeecgDataAutorUtils;
...
import com.zzc.web.cgform.service.autolist.CgTableServiceI;
import com.zzc.web.cgform.service.autolist.ConfigServiceI;
import com.zzc.web.cgform.service.config.CgFormFieldServiceI;
import com.zzc.web.cgform.util.QueryParamUtil;
import com.zzc.web.system.pojo.base.DictEntity;
...
public class CgAutoListController extends BaseController{
	...
	public void list(String id, HttpServletRequest request,
		...
		String html = viewEngine.parseTemplate("/com/zzc/web/cgform/engine/autolist/autolist.ftl", paras);
		try {
