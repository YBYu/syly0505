package com.zzc.web.cgform.service.impl.autolist;
...
import com.zzc.web.cgform.common.CommUtils;
		...
		try{
			...
			if(data!=null){
			    ...
			    while(it.hasNext()){
			        ...
			        com.zzc.core.util.LogUtil.info("name:"+ok.toString()+";value:"+ov.toString());
			    }
