...
import com.zzc.web.cgreport.entity.core.CgreportConfigHeadEntity;
import com.zzc.web.cgreport.entity.core.CgreportConfigItemEntity;
import com.zzc.web.cgreport.page.core.CgreportConfigHeadPage;
import com.zzc.web.cgreport.service.core.CgreportConfigHeadServiceI;
...
public class CgreportConfigHeadController extends BaseController {
	...
	public ModelAndView cgreportConfigHead(HttpServletRequest request) {
		return new ModelAndView("zzc/cgreport/core/cgreportConfigHeadList");
	}
	...
	public void datagrid(CgreportConfigHeadEntity cgreportConfigHead,HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid) {
		...
		//查询条件组装器
		com.zzc.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq, cgreportConfigHead);
		try{
		//自定义追加查询条件
		}catch (Exception e) {
	...
	public ModelAndView goAdd(CgreportConfigHeadEntity cgreportConfigHead, HttpServletRequest req) {
		...
		return new ModelAndView("zzc/cgreport/core/cgreportConfigHead-add");
	}
	...
	public ModelAndView goUpdate(CgreportConfigHeadEntity cgreportConfigHead, HttpServletRequest req) {
		...
		return new ModelAndView("zzc/cgreport/core/cgreportConfigHead-update");
	}
	...
	public ModelAndView cgreportConfigItemList(CgreportConfigHeadEntity cgreportConfigHead, HttpServletRequest req) {
		...
		return new ModelAndView("zzc/cgreport/core/cgreportConfigItemList");
	}
