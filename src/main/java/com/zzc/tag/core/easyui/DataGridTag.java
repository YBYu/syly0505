package com.zzc.tag.core.easyui;
...
import com.zzc.core.enums.SysThemesEnum;
import com.zzc.core.util.ApplicationContextUtil;
import com.zzc.core.util.MutiLangUtil;
import com.zzc.core.util.ResourceUtil;
import com.zzc.core.util.StringUtil;
import com.zzc.core.util.SysThemesUtil;
import com.zzc.core.util.oConvertUtils;
import com.zzc.tag.vo.easyui.ColumnValue;
import com.zzc.tag.vo.easyui.DataGridColumn;
import com.zzc.tag.vo.easyui.DataGridUrl;
import com.zzc.tag.vo.easyui.OptTypeDirection;
import com.zzc.web.system.pojo.base.TSOperation;
import com.zzc.web.system.pojo.base.TSType;
import com.zzc.web.system.pojo.base.TSTypegroup;
...
//			}
					...
					if (col.isQuery()) {
						...
						if("single".equals(col.getQueryMode())){
							if(!StringUtil.isEmpty(col.getReplace())){
								sb.append("<select name=\""+col.getField().replaceAll("_","\\.")+"\" WIDTH=\"100\" style=\"width: 140px\"> ");
								...
								sb.append("<input class=\"inuptxt\" onkeypress=\"EnterPress(event)\" onkeydown=\"EnterPress()\"  type=\"text\" name=\""+col.getField().replaceAll("_","\\.")+"\"  "+extendAttribute(col.getExtend())+" style=\"width: 140px\" />");
							}
							...
							sb.append("<span style=\"display:-moz-inline-box;display:inline-block;width: 110px;text-align:center;\">至</span>");
	...
	public String getNoAuthOperButton(){
		...
		com.zzc.core.util.LogUtil.info("----getNoAuthOperButton-------"+sb.toString());
		return sb.toString(); 
	}
	...
	private void appendele(StringBuffer sb, DataGridColumn col, String str) {

		if(!StringUtil.isEmpty(col.getReplace())){
			sb.append("<select name=\""+col.getField().replaceAll("_","\\.")+str+"\" WIDTH=\"100\" style=\"width: 140px\"> ");
			sb.append(StringUtil.replaceAll("<option value =\"\" >{0}</option>", "{0}", MutiLangUtil.getMutiLangInstance().getLang("common.please.select")));
			String[] test = col.getReplace().split(",");
			String text = "";
			String value = "";
			...
			sb.append("<input class=\"inuptxt\" onkeypress=\"EnterPress(event)\" onkeydown=\"EnterPress()\"  type=\"text\" name=\""+col.getField().replaceAll("_","\\.")+str+"\"  "+extendAttribute(col.getExtend())+" style=\"width: 140px\" />");
		}
