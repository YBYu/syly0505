...
public class TagUtil {
	...
	public static JSONObject getJson(Map dg) {
		JSONObject jObject = null;
		try {
				jObject = JSONObject.parseObject(listtojson(dg.get("fields").toString().split(","), Integer.parseInt(dg.get("total").toString()), (List)dg.get("results"),null));
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jObject;
